...
namespace TransitHub.Migrations
{
    ...
    [Migration("20250923175141_UpdateWaitlistQueueForPriority")]
    partial class UpdateWaitlistQueueForPriority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransitHub.Models.Coach", b =>
                {
            ...
            modelBuilder.Entity("TransitHub.Models.EmailVerificationOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TransitHub.Models.Seat", b =>
                {
            ...
            modelBuilder.Entity("TransitHub.Models.TrainBooking", b =>
                {
                    b.Property<int>("BookingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("AutoAssignSeats")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("SelectedQuota")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("TransitHub.Models.TrainBookingPassenger", b =>
                {
                    b.Property<int>("PassengerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TrainBookingPassengers");
                });
            ...
            modelBuilder.Entity("TransitHub.Models.WaitlistQueue", b =>
                {
                    ...
                    b.Property<int?>("FlightScheduleScheduleID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FlightScheduleScheduleID");

                    b.HasIndex("Position");

                    b.HasIndex("TrainScheduleID");

                    b.ToTable("WaitlistQueues");
                });
            ...
            modelBuilder.Entity("TransitHub.Models.Coach", b =>
                {
                    ...
                    b.HasOne("TransitHub.Models.Train", null)
                        .WithMany("Coaches")
            ...
            modelBuilder.Entity("TransitHub.Models.Seat", b =>
                {
                    b.HasOne("TransitHub.Models.Coach", "Coach")
                        .WithMany("Seats")
            ...
            modelBuilder.Entity("TransitHub.Models.TrainBooking", b =>
                {
                    b.HasOne("TransitHub.Models.TrainSchedule", "Schedule")
                        .WithMany()
            ...
            modelBuilder.Entity("TransitHub.Models.TrainBookingPassenger", b =>
                {
                    b.HasOne("TransitHub.Models.TrainBooking", "Booking")
                        .WithMany("Passengers")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TransitHub.Models.WaitlistQueue", b =>
                {
                    ...
                    b.HasOne("TransitHub.Models.FlightSchedule", null)
                        .WithMany("WaitlistQueues")
                        .HasForeignKey("FlightScheduleScheduleID");
