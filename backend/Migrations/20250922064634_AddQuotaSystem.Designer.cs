...
namespace TransitHub.Migrations
{
    ...
    [Migration("20250922064634_AddQuotaSystem")]
    partial class AddQuotaSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransitHub.Models.TrainCoach", b =>
                {
                    ...
                    b.Property<string>("QuotaAllocations")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TransitHub.Models.TrainSeat", b =>
                {
            ...
            modelBuilder.Entity("TransitHub.Models.TrainSeat", b =>
                {
                    ...
                    b.HasOne("TransitHub.Models.TrainCoach", "Coach")
                        .WithMany("Seats")
                        .HasForeignKey("CoachId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TransitHub.Models.TrainBookingPassenger", "Passenger")
                        .WithMany()
